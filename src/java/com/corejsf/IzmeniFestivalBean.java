...
// */
//@ViewScoped
//@Named("izmeniFestivalBean")
//public class IzmeniFestivalBean implements Serializable {
//    private int korak = 0;
//    
...
//    private List<Nastupa> izvodjaciFestivala = new ArrayList<>();
//    private List<Nastupa> toDeleteIzvodjaci = new ArrayList<>();
//    private List<Nastupa> izvodjaciFestivalaBackup = Collections.EMPTY_LIST;
//    
...
//    }
//    
//    public void loadFest(){
//        if(idFest != null){
//            festival = helper.getFestivalById(idFest);
//            idgrupe = festival.getFestivalgrupa().getIdgrupe();
//            slike.addAll(festival.getMedias());
//            slike.removeIf((Media m) -> {
//                return m.getTip() != 1 && m.getTip() != 3;
//            });
//            video.addAll(festival.getMedias());
//            video.removeIf((Media m)-> {
//                return m.getTip() != 2 && m.getTip() != 4;
//            });
//            for(Dan d : festival.getDans()){
//                izvodjaciFestivala.addAll(d.getNastupas());
//            }
//        }
//    }
//    
...
//    }
//    
//    public void deleteIzvodjaci(){
//        izvodjaciFestivalaBackup = new ArrayList<>(izvodjaciFestivala);
//        izvodjaciFestivala.removeAll(toDeleteIzvodjaci);
//        for(Dan d : festival.getDans()){
//            d.getNastupas().removeAll(toDeleteIzvodjaci);
//        }
//    }
//    
...
//    }
//
//    public List<Nastupa> getIzvodjaciFestivala() {
//        return izvodjaciFestivala;
//    }
//
//    public void setIzvodjaciFestivala(List<Nastupa> izvodjaciFestivala) {
//        this.izvodjaciFestivala = izvodjaciFestivala;
//    }
//
//    public List<Nastupa> getToDeleteIzvodjaci() {
//        return toDeleteIzvodjaci;
//    }
//
//    public void setToDeleteIzvodjaci(List<Nastupa> toDeleteIzvodjaci) {
//        this.toDeleteIzvodjaci = toDeleteIzvodjaci;
//    }
//    
//    
//    
