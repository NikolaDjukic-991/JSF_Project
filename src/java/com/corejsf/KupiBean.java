 ...
 * @author John
 */
@Named(value = "kupiBean")
@ViewScoped
public class KupiBean implements Serializable{
    ...
    public void kupi(){
        ...
        if(tiprez.equals("paket")){
            if(helper.rezervisiPaket(fest, null, brKarata) == 0){
                ret = "paketsuccess";
            } else {
                ret = "paketfailiure";
            }
        ...
        if(tiprez.equals("dan")){
            ...
            if(helper.rezervisiDan(izabran, null, brKarata) == 0){
                ret = "dansuccess";
            } else {
                ret = "danfailiure";
            }
